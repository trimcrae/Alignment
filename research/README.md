...
6. **Token budget.** How much of the Max plan's usage to reserve for this repo. This session's research fan-out exhausted the session limit; ongoing work should favor small, targeted runs and put deterministic work (crawling, hashing, diffing) in GitHub Actions rather than in LLM sessions.
